...
int main() {
    ...
    unsigned char echo_str_code[] = {
        ...
        0x48, 0xBE, 0xDE, 0xAD, 0xBE, 0xEF, 0x00, 0x00, 0x00, 0x00, /* movabs rsi, 0x00 (will be relocated) */
        0xBA, 0x09, 0x00, 0x00, 0x00, /* mov edx, 0x00 (will be relocated) */
        0x0F, 0x05, /* syscall */
        0xB8, 0x3C, 0x00, 0x00, 0x00, /* mov eax, 0x3c (60 = exit) */
        0xBF, 0x00, 0x00, 0x00, 0x00, /* mov edi, 0x0 (exit code 0) */
        0x0F, 0x05, /* syscall */
        'H', 'e', 'l', 'l', 'o', '\n', '\0'
    };
    ...
    /* link the code */
    buffer = NULL;
    n = rd_elf_link64(RD_ELFHDR_MACHINE_X86_64, code, data, 0, relocs, &buffer);
